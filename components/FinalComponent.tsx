...
export default function FinalComponent({ balance }: FinalComponentProps) {
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      // Dispara evento de conversão com Facebook Pixel
      try {
      ...
      try {
        if (typeof window !== "undefined" && (window as any).utmify) {
          (window as any).utmify.conversion('final-page-reached')
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="bg-white shadow-sm border-b border-gray-200 sticky top-0 z-10">
        <div className="flex items-center justify-between px-3 sm:px-6 py-3 sm:py-4 max-w-7xl mx-auto">
          ...
          <div className="bg-gradient-to-r from-blue-500 to-blue-600 text-white px-3 sm:px-6 py-2 sm:py-3 rounded-xl font-bold text-lg sm:text-xl shadow-lg">
            $ {balance.toFixed(2)}
          </div>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-3 sm:px-6 py-4 sm:py-8">
            ...
            {isClient ? (
              <div 
                dangerouslySetInnerHTML={{
                  __html: '<vturb-smartplayer id="vid-68ced59dc9c4c158bda75c09" style="display: block; margin: 0 auto; width: 100%; "></vturb-smartplayer>'
                }}
              />
            ) : (
        ...
        <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg p-4 sm:p-8 mb-6 sm:mb-8">
          <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900 mb-3 sm:mb-4 leading-tight">
            <span className="text-red-600">Secret Microtasks:</span> Earned money by watching videos? To cash out and
          ...
          <div className="flex flex-wrap items-center gap-3 sm:gap-6 text-gray-600 text-sm sm:text-base">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="font-medium text-green-600">98% liked this</span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg p-4 sm:p-8">
          <div className="flex items-center justify-between mb-6 sm:mb-8">
            ...
            <span className="text-base sm:text-lg font-semibold text-gray-600">51.826</span>
          </div>
